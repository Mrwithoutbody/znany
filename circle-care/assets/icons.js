/* ============================================================
   CARE DECK — biblioteka ikon (Lucide-style, inline SVG).
   Ładowane PRZED data.js i app.js. Wszystkie ikony siedzą tutaj.
   Użycie:  icon('flame', 18, true)   // nazwa, rozmiar, wypełnienie
   ============================================================ */
...
const ICONS = {
  ...
  layers:'<line x1="8" x2="21" y1="6" y2="6"/><line x1="8" x2="21" y1="12" y2="12"/><line x1="8" x2="21" y1="18" y2="18"/><line x1="3" x2="3.01" y1="6" y2="6"/><line x1="3" x2="3.01" y1="12" y2="12"/><line x1="3" x2="3.01" y1="18" y2="18"/>',
  ...
  clap:'<path d="M11 17a4 4 0 0 1-8 0V7a1 1 0 0 1 2 0v6"/><path d="M7 17a4 4 0 0 0 8 0V5a1 1 0 0 1 2 0v8"/><path d="M19 13a1 1 0 0 1 2 0v2a8 8 0 0 1-8 8"/>',

  /* mock awatara (gdy brak zdjęcia) */
  userRound:'<circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 0 0-16 0"/>',

  /* ikony kategorii specjalistów */
...
function icon(name, size, fill){
  size = size||20;
  return `<svg class="icon" width="${size}" height="${size}" viewBox="0 0 24 24" fill="${fill?'currentColor':'none'}" `
       + `stroke="${fill?'none':'currentColor'}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${ICONS[name]||''}</svg>`;
}
